    ...
    for receipt in result:
        ...
        for log in logs:
            ...
            if len(topics)==4 and topics[0]==event_select:                
                fromAddr=deal_topics_item(topics[2])
                toAddr=deal_topics_item(topics[1])
...
def main():
    outputCsv="/geth/nft_analyse/data/looksRare/receipt_takerBid.csv"
    dealZipFile(receipt_path,outputCsv)

receipt_path="/receipt2/"
event_select="0x95fb6205e23ff6bda16a2d1dba56b9ad7c783f67c96fa149785052f47696f2be"
