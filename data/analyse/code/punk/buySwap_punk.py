...
def get_Cost_fromEvent(OrdersMatched_csv,txMap):
    with open(OrdersMatched_csv,'r', encoding="UTF8") as f:
        ...
        for row in reader:
            ...
            toAddress=row[2]
            price=row[3]
            if toAddress=="0x0000000000000000000000000000000000000000" or price=="0":
                continue
...
def main():
    outputPath_dict="/geth/nft_analyse/data/punk/nftSwap_txMap.data"
    outputPath_csv="/geth/nft_analyse/data/punk/nftSwap_13_14.csv"
    pairAddress_csv="/geth/nft_analyse/data/swapDex/pairWithWeth.csv"
    OrdersMatched_csv="/geth/nft_analyse/data/punk/receipt_13_15.csv"
